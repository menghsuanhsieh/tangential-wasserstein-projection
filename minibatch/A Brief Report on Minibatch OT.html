...
<title>A Brief Report on Minibatch OT</title><script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"></script>
...
<h1 id="A-Brief-Report-on-Minibatch-OT">A Brief Report on Minibatch OT<a class="anchor-link" href="#A-Brief-Report-on-Minibatch-OT">&#182;</a></h1>
</div>
</div>
<div class="jp-Cell-inputWrapper"><div class="jp-InputPrompt jp-InputArea-prompt">
</div><div class="jp-RenderedHTMLCommon jp-RenderedMarkdown jp-MarkdownOutput " data-mime-type="text/markdown">
<h2 id="Logistics">Logistics<a class="anchor-link" href="#Logistics">&#182;</a></h2><p>The minibatch method calculates the average of transport maps between smaller samples selected from the source and target distributions, and gets the OT map between the population source and target. The main advantage of considering this method is that we can compute maps for large datasets using smaller samples, which makes the process more computationally efficient.
<br></p>
<p>The tradeoff with this algorithm is between the accuracy and computing costs. If the size of each batch is small, the computation will take less time, but the resulting OT map will be 'blurred out'.
<br></p>
<p>The minibatch method has 'emd' and 'entropic' modes, meaning that a single transport map between the mini batch can be calculated by either the <code>ot.emd</code> function or the <code>ot.sinkhorn</code> function. The 'emd' option gives a much clearer OT map, but the computation takes longer and the sample size requirements are severe for high-dimensional data.</p>
...
<li>Decide whether the use of minibatch method is valid</li>
</ul>
